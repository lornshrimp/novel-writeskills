...
- 单场默认也尽量看出“钩子 → 蓄力 → 回报 / 变线 → 留钩”的最小四拍，不得从头到尾只有一种平推节奏。- **反应方落点**：凡是写出打破均势的动作（挑衅、意外、信息差、环境异变），必须配对一个可感知的反应——至少一个人物产生情绪、行动或态度上的变化；只有动作没有反应等于爽点只写了一半，审阅层将标记为 P1。- 若本场承担关系推进职责，至少要让关系状态出现一次可感知变化，而不只是信息交换。
